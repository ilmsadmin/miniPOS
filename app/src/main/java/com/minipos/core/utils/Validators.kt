...
object Validators {
    fun isValidStoreName(name: String): Boolean = name.isNotBlank()
    ...
    fun isValidDisplayName(name: String): Boolean = name.isNotBlank() && name.length <= 100
    ...
    fun isValidQuantity(qty: Double): Boolean = qty > 0
}
